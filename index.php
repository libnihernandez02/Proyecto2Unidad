...
<body background="images/fondo.jpg" style="background-attachment: fixed" >
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td><label style="font-size: 15pt"><b>Correo: </b></label></td>
			<td width=80> <input class="form-group has-success" style="border-radius:15px;" type="text" name="mail"></td></tr>
		<tr><td><label style="font-size: 15pt"><b>Contraseña: </b></label></td>
...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      <label style="font-size: 15pt"><b>Ingresa tu nombre</b></label>
      <input type="text" name="realname" class="form-control" placeholder="Ingresa tu nombre" />
    </div>
    <div class="form-group">
      <label style="font-size: 15pt; color: #000000;"><b>Ingresa tu email</b></label>
      <input type="text" name="nick" class="form-control"  required placeholder="Ingresa mail"/>
    </div>
    <div class="form-group">
      <label style="font-size: 15pt; color: #000000;"><b>Ingresa tu Password</b></label>
      <input type="password" name="pass" class="form-control"  placeholder="Ingresa contraseña" />
    </div>
    <div class="form-group">
      <label style="font-size: 15pt"><b>Repite tu contraseña</b></label>
